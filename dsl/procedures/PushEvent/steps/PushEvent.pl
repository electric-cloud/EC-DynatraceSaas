...
sub main() {
    ...
    if(%configuration){
        ...
        if($configuration{'DT_URL'} ne '' && $configuration{'DT_TOKEN'} ne '' ){
            ...
            my %event_params= ('BUILDURL', '$[/myCall/BUILDURL]', 'CILINK', '$[/myCall/CILINK]', 'DEPLOYMENTNAME', '$[/myCall/DEPLOYMENTNAME]',
                               'DEPLOYMENTPROJECT', '$[/myCall/DEPLOYMENTPROJECT]', 'DEPLOYMENTVERSION', '$[/myCall/DEPLOYMENTVERSION]' ,
                               'ENTITYTYPE', '$[/myCall/ENTITYTYPE]', 'GITCOMMIT', '$[/myCall/GITCOMMIT]', 'TAGCONTEXT', '$[/myCall/TAGCONTEXT]',
                               'TAGNAME', '$[/myCall/TAGNAME]', 'TAGVALUE', '$[/myCall/TAGVALUE]');
            
            my $text = $clientREST->push_event(%event_params);
